...
<body>
  ...
  <section id="header" style="padding: 30px; font-family: 'Montserrat', sans-serif;">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <?php if (isset($_SESSION['uname'])) : ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="flighshedule.php?searchlogout='1'"><i class="fa fa-sign-out" aria-hidden="true"></i>Sign Out</a>
            </li>
          <?php else : ?>
            <li class="nav-item">
  ...
  <section id="box" style="font-family: 'Montserrat', sans-serif;">
    <div class="container text-center ">
      <h1 class="py-4  text-light "> <i class="fas fa-paper-plane" aria-hidden="true"></i> Search Flights</h1>
      <section id="Alertmsg">
        <div class="alertmsg ">
                      ...
                      while ($row = mysqli_fetch_assoc($result) and $brow = mysqli_fetch_assoc($bresult) and $frow = mysqli_fetch_assoc($fresult)) { ?>
                        <tr>
                          ...
                          <td> <?php if (isset($_SESSION['uname'])) : ?>
                              <a href="booking.php?Book=<?php echo $row['Travel_code']; ?>&Day=<?php echo $row['Day_ID']; ?>&Time_ID=<?php echo $row['Time_ID']; ?>" <button type="submit" class="btn btn-primary my-0 py-1 px-2" data-toggle="tooltip" data-placement="bottom" title="Book" name="button">
                                <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button></a>
                            <?php else :
                                  $_SESSION['mesage'] = "You must login to book tickets";
                            ?>
                              <a href="signin.php?Book=<?php echo $row['Travel_code']; ?>&Day=<?php echo $row['Day_ID']; ?>&Time_ID=<?php echo $row['Time_ID']; ?>" <button type="submit" class="btn btn-primary my-0 py-1 px-2" data-toggle="tooltip" data-placement="bottom" title="Book" name="button">
                                <i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button></a>
                            <?php endif ?>
                          </td>
  ...
  <section class="footer" style="font-family: 'Montserrat', sans-serif;">
    ...
    <div class="box">
      <div class="copyright">
        ...
        Designed with <i class="fa fa-heart" aria-hidden="true"></i> by Aarati Patil
      </div>
    </div>
  </section>
