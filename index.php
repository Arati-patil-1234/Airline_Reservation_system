...
<body>
  <section class="header" style="padding: 30px; font-family: 'Montserrat', sans-serif;">
    <section id="nav-bar">
      <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="index.php"><img class="img" src="travel.png">Airline reservation system</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="flightsearch.php"><i class="fa fa-plane" aria-hidden="true"></i>flight schedules</a>
            </li>
            ...
            <?php if (isset($_SESSION['uname'])) : ?>
              ...
              <li class="nav-item">
                <a class="nav-link" href="userprofile.php"><i class="fa fa-address-card" aria-hidden="true"></i>Your profile</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="index.php?homelogout='1'"><i class="fa fa-sign-out" aria-hidden="true"></i>Sign Out</a>
              </li>
            <?php else : ?>
              <li class="nav-item">
    ...
    <div class="welcome-msg">
      ...
      <a href="flightsearch.php" class="btn btn-book">Book Now</a>
    </div>
    <!-- <img src="whitewaves.png" class="fluid"> -->
  </section>

  <div class='container-fluid mx-auto mt-5 mb-5 col-12' style="text-align: center; font-family: 'Montserrat', sans-serif;">
    ...
    <div class="row" style="justify-content: center">
      <div class="card col-md-3 col-12">
        <div class="card-content">
          <div class="card-body"> <img class="service_img" src="https://i.imgur.com/S7FJza5.png" />
            <div class="shadow"></div>
            <div class="card-title"> Hassle free transaction </div>
      ...
      <div class="card col-md-3 col-12 ml-2">
        <div class="card-content">
          <div class="card-body"> <img class="service_img" src="https://i.imgur.com/xUWJuHB.png" />
      ...
      <div class="card col-md-3 col-12 ml-2">
        <div class="card-content">
          <div class="card-body"> <img class="service_img rck" src="https://i.imgur.com/rG3CGn3.png" />
            <div class="card-title"> User privacy </div>
            <div class="card-subtitle">
  ...
  <section id="carousel">
    <div class="car" style="font-family: 'Montserrat', sans-serif;">
  ...
  <section id="bestsellers" style="font-family: 'Montserrat', sans-serif;">
      ...
      <div class="col-md-3">
        <div class="card shadow">
          ...
          <div class="card-body text-center">
            ...
            <a href="flightsearch.php" class="btn btn-primary">Book Now</a>
          </div>
        </div>
      </div>
      <div class="col-md-3">
  ...
  <section class="footer" style="font-family: 'Montserrat', sans-serif;">
    <div class="container">
      <div class="row">
    ...
    <div class="box">
      <div class="copyright">
        ...
        Designed with <i class="fa fa-heart" aria-hidden="true"></i> by Arati Patil
      </div>
    </div>
  </section>
