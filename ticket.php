...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <?php if (isset($_SESSION['uname'])) : ?>
              <li class="nav-item">
                <a class="nav-link" href="flightsearch.php?searchlogout='1'"><i class="fa fa-sign-out" aria-hidden="true"></i>Sign Out</a>
              </li>
            <?php else : ?>
              <li class="nav-item">
  ...
  <section id="container" style="font-family: 'Montserrat', sans-serif;">
    ...
    <?php if ($count > 0) { ?>
      ...
      ?>
        <div class="row" id="section-to-print">
          ...
          <div class="col-md-3 content " style="font-family: 'Montserrat', sans-serif;">
      ...
      <div class="text-center">
        <div class="alert alert-primary" role="alert">
          Oops! such emptiness <a href="flightsearch.php" class="alert-link">Book Now</a> and travel with joy.
        </div>
      </div>
      <div class="text-center">
        <div class="space">
